...
public class ChatRoomController {
    ...
    public ChatRoomDto register(
            ...
            @RequestParam(value = "post_id") Long postId // nickname을 받는 이유? userid, email 보안적으로 넘기기 좀 그럼 따라서 이메일을 받고 서버 내에서 entity를 찾는 식으로
            ) {
        return chatRoomBusiness.register(user, postId); // 그렇네 postId를 알면 누구 글인지 알잖어 그러면 그 게시글에서 그 사람이랑의 채팅방이니까 그대로 구현
    }
